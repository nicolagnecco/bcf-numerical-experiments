...
def simulation_run(
    *,
    ...
    #  generate datasets
    X_train, y_train, Z_train, S, M, gamma = generate_data_radial_f(
        n_train,
        int_train,
        f,
    ...
    methods = [
        ...
        (
            ...
            BCFMLP(
                ...
                lr_f=1e-3,
                lr_g=1e-3,
                weight_decay_f=2.5e-2,
                weight_decay_g=2.5e-2,
                predict_imp=False,
            ),
        ),
        (
        ...
        (
            ...
            BCFMLP(
                ...
                lr_f=1e-3,
                lr_g=1e-3,
                weight_decay_f=2.5e0,
                weight_decay_g=2.5e0,
                predict_imp=False,
            ),
        ),
        (
            ...
            BCFMLP(
                ...
                lr_f=1e-3,
                lr_g=1e-3,
                weight_decay_f=2.5e1,
                weight_decay_g=2.5e1,
                predict_imp=False,
            ),
        ),
        (
